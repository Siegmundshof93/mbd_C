...
#define cs_set() HAL_GPIO_WritePin(GPIOA,GPIO_PIN_8,GPIO_PIN_RESET)
#define cs_reset() HAL_GPIO_WritePin(GPIOA,GPIO_PIN_8,GPIO_PIN_SET)
...
void Write_Flash(uint16_t data, uint32_t page_addr);
void Erase(void);
void W25_Ini(void);
